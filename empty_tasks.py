...
def prog(init_cpu, decorator_cpu):

    # empty task
    @ray.remote(num_cpus=decorator_cpu)
    def empty_fn():
        return
    ...
    ray.init(num_cpus=init_cpu, log_to_driver=False, logging_level=logging.FATAL) # removing warnings
